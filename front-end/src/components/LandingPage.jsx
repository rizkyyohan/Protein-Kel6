      ...
      <section className="container mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div>
          <h1 className="text-4xl font-extrabold text-[#2B2A4C] mb-4 leading-tight">
            Mulai perjalanan Anda dengan <span className="text-[#FF7C57]">TravelAble</span> dan jelajahi destinasi tanpa batas!
          </h1>
          <p className="text-lg text-[#6F6F88] mb-8">Rencanakan dan jalani perjalanan sempurna Anda dengan saran ahli, kiat perjalanan, informasi destinasi, dan inspirasi dari kami!</p>
        </div>
        <div className="relative">
          <img src={G1} className="rounded-lg shadow-lg" alt="Travel" />
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 items-center gap-8">
          ...
          <div className="relative flex justify-center items-center">
            <div className="bg-gradient-to-b from-[#2B2A4C] to-transparent rounded-full p-8">
              <img src={require("../components/assets/image.png")} alt="Panduan Eksklusif" className="rounded-full shadow-lg" />
            </div>
          </div>
          {/* Konten */}
          <div>
            <h2 className="text-3xl font-extrabold text-[#2B2A4C] mb-4">Panduan Eksklusif untuk Pemandu</h2>
            <p className="text-lg text-[#6F6F88] mb-6">Klik di bawah ini untuk panduan eksklusif pemandu yang mempermudah perjalanan Anda.</p>
            <button className="bg-[#FF7C57] hover:bg-orange-600 text-white font-semibold px-6 py-2 rounded-lg shadow-md">Panduan Pemandu</button>
          </div>
        </div>
      </section>
